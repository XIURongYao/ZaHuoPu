...
<html>
  <head>
    ...
    <title>My JSP 'SellUpdate.jsp' starting page</title>
  ...
  <body>
     ...
     height:450px;">
     <!-- 修改书籍 -->
              <h2><span style="color:gray;" onmouseover="dianji('3s','jichu')">销售管理 > 销售信息查看 </span> 
              >修改销售商品信息（Sell）</h2>
              <hr/>
              <div style="width:500px;border:0px solid red;margin:auto;height:350px;
        text-align:center;">
        <form action="http://localhost:8080/ZaHuoPu/updateSell.action" method="post"
   ...
   <table id="table">
              ...
              <td>
              <input type="text" name="se_id" value="<%=request.getParameter("se_id")%>" readonly="readonly">
              </td>
